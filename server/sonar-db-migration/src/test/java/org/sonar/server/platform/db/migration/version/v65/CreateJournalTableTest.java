...
public class CreateJournalTableTest {

  private static final String TABLE = "es_journal";
  ...
  private CreateJournalTable underTest = new CreateJournalTable(db.database());
