...
public class BuiltInQualityProfilesNotificationTest {
  ...
  public void does_not_send_mail_if_no_quality_profile_is_updated() throws Exception {
    ...
    WsUsers.CreateWsResponse.User profileAdmin1 = userRule.createUser();
    ...
    WsUsers.CreateWsResponse.User profileAdmin2 = userRule.createUser();
    ...
    WsUsers.CreateWsResponse.User noProfileAdmin = userRule.createUser();
